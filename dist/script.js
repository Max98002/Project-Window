...
/* harmony import */ var _modules_showBigImg__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./modules/showBigImg */ "./src/js/modules/showBigImg.js");
...
window.addEventListener('load', function () {
  ...
  Object(_modules_timer__WEBPACK_IMPORTED_MODULE_5__["default"])('.container1', '2021-08-25');
  Object(_modules_showBigImg__WEBPACK_IMPORTED_MODULE_6__["default"])();
});
...
var changeModalState = function changeModalState(state) {
  ...
  Object(_validation__WEBPACK_IMPORTED_MODULE_1__["default"])(windowWidth, /\D/ig);
  Object(_validation__WEBPACK_IMPORTED_MODULE_1__["default"])(windowHeight, /\D/ig);

  var bindActionToElements = function bindActionToElements(elem, action, prop) {
        ...
        switch (item.nodeName) {
          ...
          case "INPUT":
            if (item.getAttribute('type') === 'checkbox') {
              i === 0 ? state[prop] = 'Теплое' : state[prop] = 'Холодное';
  ...
  bindActionToElements(windowWidth, 'change', 'width');
  bindActionToElements(windowHeight, 'change', 'height');
...
/* harmony import */ var _services_service__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../services/service */ "./src/js/services/service.js");
...
var forms = function forms(selectorForm, state) {
  var form = document.querySelectorAll(selectorForm);
  var phoneNumber = document.querySelectorAll('input[name="user_phone"]');
  var userName = document.querySelectorAll('input[name="user_name"]');
  Object(_validation__WEBPACK_IMPORTED_MODULE_5__["default"])(phoneNumber, /\D/ig);
  Object(_validation__WEBPACK_IMPORTED_MODULE_5__["default"])(userName, /\d/ig);
  var messege = {
    success: 'Success',
    loading: 'Loading...',
    fail: 'Fail'
  ...
  form.forEach(function (form) {
    form.addEventListener('submit', function (e) {
      e.preventDefault();
      var success = messege.success,
          loading = messege.loading,
          fail = messege.fail;
      var messegeBlock = document.createElement('p');
      messegeBlock.style.color = 'red';
      messegeBlock.innerHTML = loading;
      form.appendChild(messegeBlock);
      ...
      Object(_services_service__WEBPACK_IMPORTED_MODULE_4__["default"])('assets/server.php', formData).then(function (data) {
        messegeBlock.innerHTML = success;
        console.log(data);
      }).catch(function (err) {
        ...
        setTimeout(function () {
          ...
          if (form.getAttribute('data-calc') === 'end') {
            form.closest('.popup_calc_end').classList.remove('show');
...
var modals = function modals() {
  var bindModal = function bindModal(triggerModal, triggersBtns, triggerClose) {
    var clickModalOverlay = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : true;
    var modalWindow = document.querySelector(triggerModal),
        modalBtns = document.querySelectorAll(triggersBtns),
        modalClose = document.querySelector(triggerClose),
        windows = document.querySelectorAll('[data-modal]');

    var closeAllWindow = function closeAllWindow(arr) {
  ...
  function showModalByTime(selector, time) {
    setTimeout(function () {
      document.querySelector(selector).classList.add('showB', 'animate__animated', 'animate__fadeIn');
    }, time);
  }

  bindModal('.popup', '.phone_link', '.popup .popup_close');
  bindModal('.popup_engineer', '.popup_engineer_btn', '.popup_engineer .popup_close');
  bindModal('.popup_calc', '.popup_calc_btn', '.popup_calc .popup_calc_close');
  bindModal('.popup_calc_profile', '.popup_calc_button', '.popup_calc_profile .popup_calc_profile_close', false);
  bindModal('.popup_calc_end', '.popup_calc_profile_button', '.popup_calc_end .popup_calc_end_close', false); // showModalByTime('.popup', 60000);
};
...
"use strict";
__webpack_require__.r(__webpack_exports__);
var showBigImg = function showBigImg() {
...
/* harmony default export */ __webpack_exports__["default"] = (showBigImg);
...
var tabs = function tabs(headerSelector, tabSelector, contentSelector, activeClass) {
  ...
  var hideTaba = function hideTaba() {
  ...
  var setClock = function setClock(selector, endTime) {
    ...
    function updateClock() {
      var _getTimeRemaining = getTimeRemaining(endTime),
          t = _getTimeRemaining.total,
          s = _getTimeRemaining.seconds,
          m = _getTimeRemaining.minuts,
          h = _getTimeRemaining.hours,
          d = _getTimeRemaining.days;
...
var validation = function validation(input, str) {
